...
def write_performance_test( diffs ):
    with open('performance_test.py', 'w') as datei:
        ...
        for degree, mat in diffs.items():
            ...
            datei.write('dict_chaincomplex[{degree}] = matrix(ZZ, {num_rows}, {num_cols}, {bdry_matrix_dict}, sparse=True)\n'.format(degree=degree, num_rows=num_rows, num_cols=num_cols, bdry_matrix_dict=bdry_matrix_dict) )
