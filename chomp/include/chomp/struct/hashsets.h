...
// make the chomp::homology hashkey methods global ones
...
// import the global hashkey functions to the chomp::homology namespace
using ::hashkey1;
using ::hashkey2;

// class templates defined within this header file (in this order):
template <class element, class hashing>
class hashedset;
...
// --------------------------------------------------
// ------------- basic hashing methods --------------
// --------------------------------------------------

/// A hashing method using globally defined functions that calculate
/// the two required hashing keys.
...
public:
	...
	{
		return chomp::homology::hashkey1 (x);
	}

	/// Returns the second hashing key of the element.
	static int_t hashkey2 (const element &x)
	{
		return chomp::homology::hashkey2 (x);
	}

}; /* class HashingGlobal */


/// A hashing method using member functions that calculate
/// the two required hashing keys.
template <class element>
class HashingMember
{
...
public:
	...
	void intersection (const hashedset<element,hashkeys> &s1,
...
const int_t hashedset<element,hashkeys>::InitHashSize (137);

template <class element, class hashkeys>
const int_t hashedset<element,hashkeys>::InitTabSize (30);

template <class element, class hashkeys>
const int_t hashedset<element,hashkeys>::StartHashingSize (30);

// --------------------------------------------------

template <class element, class hashkeys>
hashedset<element,hashkeys>::hashedset (int_t initialsize, int bequiet):
...
template <class element, class hashkeys>
hashedset<element,hashkeys>::hashedset (const hashedset<element,hashkeys> &s):
...
template <class element, class hashkeys>
hashedset<element,hashkeys> &hashedset<element,hashkeys>::operator =
	(const hashedset<element,hashkeys> &s)
{
	if (this == &s)
		return *this;
...
template <class element, class hashkeys>
int_t hashedset<element,hashkeys>::getnumber (const element &e) const
{
	if (hashing)
	{
...
template <class element, class hashkeys>
inline bool hashedset<element,hashkeys>::checknum (int_t n) const
{
	return ((n >= 0) && (n < nelem));
} /* hashedset<element,hashkeys>::checknum */

template <class element, class hashkeys>
inline bool hashedset<element,hashkeys>::check (const element &e) const
{
	return (getnumber (e) >= 0);
} /* hashedset<element,hashkeys>::check */

template <class element, class hashkeys>
inline const element &hashedset<element,hashkeys>::get (int_t n) const
{
	if ((n < 0) || (n >= nelem))
...
template <class element, class hashkeys>
inline const element &hashedset<element,hashkeys>::operator [] (int_t n) const
{
	return get (n);
} /* hashedset<element,hashkeys>::operator [] */

template <class element, class hashkeys>
inline const element &hashedset<element,hashkeys>::front () const
{
	return get (nelem - 1);
} /* hashedset<element,hashkeys>::front */

template <class element, class hashkeys>
inline const element &hashedset<element,hashkeys>::top () const
{
	return get (nelem - 1);
} /* hashedset<element,hashkeys>::top */

template <class element, class hashkeys>
int_t hashedset<element,hashkeys>::add (const element &e)
{
	if (!hashing)
	{
		for (int_t i = 0; i < nelem; ++ i)
...
template <class element, class hashkeys>
inline int_t hashedset<element,hashkeys>::push (const element &e)
{
	return add (e);
} /* hashedset<element,hashkeys>::push */

template <class element, class hashkeys>
inline int_t hashedset<element,hashkeys>::push_back (const element &e)
{
	return add (e);
} /* hashedset<element,hashkeys>::push_back */

template <class element, class hashkeys>
int hashedset<element,hashkeys>::remove (const element &e)
{
	if (!hashing)
	{
		for (int_t i = 0; i < nelem; ++ i)
...
template <class element, class hashkeys>
inline int hashedset<element,hashkeys>::removenum (int_t n)
{
	if ((n < 0) || (n >= nelem))
		return -1;
	if (!hashing)
...
template <class element, class hashkeys>
inline int_t hashedset<element,hashkeys>::pop ()
{
	if (!nelem)
...
template <class element, class hashkeys>
hashedset<element,hashkeys> &hashedset<element,hashkeys>::add (const hashedset<element,hashkeys> &s)
{
	int_t n = s. size ();
	for (int_t i = 0; i < n; ++ i)
		add (s [i]);
...
template <class element, class hashkeys>
hashedset<element,hashkeys> &hashedset<element,hashkeys>::remove (const hashedset<element,hashkeys> &s)
{
	if (this -> size () < s. size ())
	{
...
template <class element, class hashkeys>
inline bool hashedset<element,hashkeys>::empty () const
{
	return !nelem;
} /* hashedset<element,hashkeys>::empty */

template <class element, class hashkeys>
inline int_t hashedset<element,hashkeys>::size () const
{
	return nelem;
} /* hashedset<element,hashkeys>::size */

template <class element, class hashkeys>
inline void hashedset<element,hashkeys>::swap (hashedset<element,hashkeys> &other)
{
...
template <class element, class hashkeys>
inline bool hashedset<element,hashkeys>::operator ==
	(const hashedset<element,hashkeys> &other) const
{
...
template <class element, class hashkeys>
inline void hashedset<element,hashkeys>::intersection (const hashedset<element,hashkeys> &s1,
	const hashedset<element,hashkeys> &s2)
{
	int_t size1 = s1. size ();
	int_t size2 = s2. size ();
...
template <class element, class hashkeys>
int_t hashedset<element,hashkeys>::hashfind (const element &e, int_t *addpos) const
{
	if (!hashing)
...
template <class element, class hashkeys>
void hashedset<element,hashkeys>::rehash (int_t newsize)
{
	if (stat)
		++ (stat -> rehashcount);
...
template <class element, class hashkeys>
inline bool hashedset<element,hashkeys>::numberisprime (const int_t &n)
{
	if (n < 2)
		return 0;
...
template <class element, class hashkeys>
int_t hashedset<element,hashkeys>::rounduptoprime (int_t n)
{
...
template <class element, class hashkeys>
inline hashedset<element,hashkeys> &operator += (hashedset<element,hashkeys> &s,
