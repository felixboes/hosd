...
:cut
:: zip -u -9 chomp-cut lib/ bin/ obj/ obj/*/ -x */CVS/ obj/capd*/ obj/chompdemo/ obj/chomprog/
:: zip -u -9 -r chomp-cut makefile licen* include/ make/ src/ -x include/capd/* include/capd/*/* src/capd*/* make/auto_dep/capd*
:: if not .%1. == .. goto end
