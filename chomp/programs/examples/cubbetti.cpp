...
// Started on February 15, 2003. Last revision: September 8, 2003.

// Former name(s) of this program: cubdemo2.cpp (until November 11, 2003).
...
const char *title = "\
CUBBETTI, ver. 0.02. Copyright (C) 1997-2013 by Pawel Pilarczyk.\n\
This is free software. No warranty. Consult 'license.txt' for details.";

const char *helpinfo = "\
Call with: file1.cub [file2.cub].\n\
This is a demonstration program which computes the Betti numbers\n\
of a given set of cubes or a pair of sets of cubes.\n\
Optional arguments:\n\
...
void demo (char *Xname, char *Aname, int p, bool generators)
{
	...
	Chain *hom;
	Chain **gen;
	CubicalComplex *gcompl = NULL;
	int maxlevel = Homology (X, "X", A, "A", hom,
		generators ? &gen : NULL, generators ? &gcompl : NULL);
	...
	if (generators && (maxlevel >= 0))
	{
		...
		ShowGenerators (gen, hom, maxlevel, *gcompl);
		delete gcompl;
