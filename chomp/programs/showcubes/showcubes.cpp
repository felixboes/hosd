...
// Started on June 30, 2004. Last revision: October 11, 2013.
...
/// In case there is some problem with OpenGL, drawing both sides
/// of each face might probably help (but it didn't in my case).
/// Note that turning this feature on slows the plotting down twice.
const bool drawBothSides = false;
