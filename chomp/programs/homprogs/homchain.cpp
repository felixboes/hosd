...
This is free software. No warranty. Consult 'license.txt' for details.\n\
\n\
    This is NOT the original CHomP build.\n\
    The typedef 'numbertype' and the class 'integer' were altered.\n\
    Most importantly, we use 'mpz_class' instead of 'shory int'.\n\
    This allows arbitrary huge integers without overflows but\n\
